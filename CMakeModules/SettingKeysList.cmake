...
#
# Populates SETTING_KEY_LIST/SETTING_KEY_DEFINITIONS/JNI_SETTING_KEY_DEFINITIONS only; it does not
# configure_file() anything itself, so it can be include()'d from any directory scope (its
# configure_file paths would otherwise resolve against whichever CMakeLists.txt happens to be
# processing, via CMAKE_CURRENT_SOURCE_DIR/_BINARY_DIR). GenerateSettingKeys.cmake includes this
# and then does the root build's configure_file calls; the Vita port's out-of-tree build
# (vita/CMakeLists.txt) includes this directly and does its own with absolute paths.
